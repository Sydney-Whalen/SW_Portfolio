## Welcome!
<h1>Sydney Whalen</h1>
    <p><strong>Mathematical Sciences | Data Science and Analytics | Systems Science & Engineering</strong></p>
    <p>
...
<div class="project-item">
        ...
        <ul>
            ...
            <li>Performed comparative analysis between a logistic modeling and Random Forest ensemble methods.</li>
        </ul>
</div>
...
<div class="project-item">
        ...
        <ul>
            <li>Comparative visuals across regions.</li>
            <li>Written analysis critiqueing administrative policy with visualizations to support</li>
        </ul>
        </p>
</div>

<div class="project-item">
        <h3><a href="https://github.com/Sydney-Whalen/SW_Portfolio/blob/main/Immigration%20Enforcement%20Across%20U.S.%20Borders.pdf">SIR Model</a></h3>
        <p>
